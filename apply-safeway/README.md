apply-safeway-cookbook
=========================
Deploy and configure  operations on apply-safeway cookbook.
...
### apply-safeway::ecr_deploy

Deploys apply-safeway container by referring data bag item apply-safeway of communities data bag.
...
1. It runs container with specifications mentioned under data bag item apply-safeway of communities data bag.

### apply-safeway::ecr_undeploy

Remove Deployed apply-safeway container by referring data bag item apply-safeway of communities data bag.
