...
Deploys apply-safeway container by referring data bag item apply-safeway of services data bag.
...
1. It runs container with specifications mentioned under data bag item apply-safeway of services data bag.

### apply-safeway::ecr_undeploy

Remove Deployed apply-safeway container by referring data bag item apply-safeway of services data bag.
