mturk-cookbook
=========================
Deploy and configure  operations on mturk cookbook.
...
Deploys mturk container by referring data bag item mturk of communities data bag.
...
1. It runs container with specifications mentioned under data bag item mturk of communities data bag.

### mturk::ecr_undeploy

Remove Deployed mturk container by referring data bag item mturk of communities data bag.
