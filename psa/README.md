psa-cookbook
=========================
Deploy and configure  operations on psa cookbook.
...
Deploys psa container by referring data bag item psa of communities data bag.
...
1. It runs container with specifications mentioned under data bag item psa of communities data bag.

### psa::ecr_undeploy

Remove Deployed psa container by referring data bag item psa of communities data bag.
