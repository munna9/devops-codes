self-administration-cookbook
=========================
Deploy and configure  operations on self-administration cookbook.
...
### self-administration::ecr_deploy

Deploys self-administration container by referring data bag item self-administration of communities data bag.
...
1. It runs container with specifications mentioned under data bag item self-administration of communities data bag.

### self-administration::ecr_undeploy

Remove Deployed self-administration container by referring data bag item self-administration of communities data bag.
