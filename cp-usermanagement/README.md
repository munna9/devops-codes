...
Deploys cp-usermanagement container by referring data bag item cp-usermanagement of services data bag.
...
1. It runs container with specifications mentioned under data bag item cp-usermanagement of services data bag.

### cp-usermanagement::ecr_undeploy

Remove Deployed cp-usermanagement container by referring data bag item cp-usermanagement of services data bag.
