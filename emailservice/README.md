emailservice-cookbook
=========================
Deploy and configure  operations on emailservice cookbook.
...
### emailservice::ecr_deploy

Deploys emailservice container by referring data bag item emailservice of services data bag.
...
1. It runs container with specifications mentioned under data bag item emailservice of services data bag.

### emailservice::ecr_undeploy

Remove Deployed emailservice container by referring data bag item emailservice of services data bag.
