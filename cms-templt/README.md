cms-templt-cookbook
=========================
Deploy and configure  operations on cms-templt cookbook.
...
### cms-templt::ecr_deploy

Deploys cms-templt container by referring data bag item cms-templt of services data bag.
...
1. It runs container with specifications mentioned under data bag item cms-templt of services data bag.

### cms-templt::ecr_undeploy

Remove Deployed cms-templt container by referring data bag item cms-templt of services data bag.
