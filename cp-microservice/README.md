...
Deploys cp-microservice container by referring data bag item cp-microservice of services data bag.
...
1. It runs container with specifications mentioned under data bag item cp-microservice of services data bag.

### cp-microservice::ecr_undeploy

Remove Deployed cp-microservice container by referring data bag item cp-microservice of services data bag.
