...
Deploys job-scoring container by referring data bag item job-scoring of services data bag.
...
1. It runs container with specifications mentioned under data bag item job-scoring of services data bag.

### job-scoring::ecr_undeploy

Remove Deployed job-scoring container by referring data bag item job-scoring of services data bag.
