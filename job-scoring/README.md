job-scoring-cookbook
=========================
Deploy and configure  operations on job-scoring cookbook.
...
### job-scoring::ecr_deploy

Deploys job-scoring container by referring data bag item job-scoring of communities data bag.
...
1. It runs container with specifications mentioned under data bag item job-scoring of communities data bag.

### job-scoring::ecr_undeploy

Remove Deployed job-scoring container by referring data bag item job-scoring of communities data bag.
