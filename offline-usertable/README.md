offline-usertable-cookbook
=========================
Deploy and configure  operations on offline-usertable cookbook.
...
### offline-usertable::ecr_deploy

Deploys offline-usertable container by referring data bag item offline-usertable of communities data bag.
...
1. It runs container with specifications mentioned under data bag item offline-usertable of communities data bag.

### offline-usertable::ecr_undeploy

Remove Deployed offline-usertable container by referring data bag item offline-usertable of communities data bag.
