...
Deploys apply-new container by referring data bag item apply-new of communities data bag.
...
1. It runs container with specifications mentioned under data bag item apply-new of communities data bag.

### apply-new::ecr_undeploy

Remove Deployed apply-new container by referring data bag item apply-new of communities data bag.
