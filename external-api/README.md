external-api-cookbook
=========================
Deploy and configure  operations on external-api cookbook.
...
### external-api::ecr_deploy

Deploys external-api container by referring data bag item external-api of services data bag.
...
1. It runs container with specifications mentioned under data bag item external-api of services data bag.

### external-api::ecr_undeploy

Remove Deployed external-api container by referring data bag item external-api of services data bag.
