tokenmanagement-cookbook
=========================
Deploy and configure  operations on tokenmanagement cookbook.
...
### tokenmanagement::ecr_deploy

Deploys tokenmanagement container by referring data bag item tokenmanagement of services data bag.
...
1. It runs container with specifications mentioned under data bag item tokenmanagement of services data bag.

### tokenmanagement::ecr_undeploy

Remove Deployed tokenmanagement container by referring data bag item tokenmanagement of services data bag.
