service-cookbook
=========================
Deploy and configure  operations on service cookbook.
...
Deploys service container by referring data bag item service of communities data bag.
...
1. It runs container with specifications mentioned under data bag item service of communities data bag.

### service::ecr_undeploy

Remove Deployed service container by referring data bag item service of communities data bag.
