semantic-cookbook
=========================
Deploy and configure  operations on semantic cookbook.
...
Deploys semantic container by referring data bag item semantic of communities data bag.
...
1. It runs container with specifications mentioned under data bag item semantic of communities data bag.

### semantic::ecr_undeploy

Remove Deployed semantic container by referring data bag item semantic of communities data bag.
