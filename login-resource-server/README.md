login-resource-server-cookbook
=========================
Deploy and configure  operations on login-resource-server cookbook.
...
### login-resource-server::ecr_deploy

Deploys login-resource-server container by referring data bag item login-resource-server of communities data bag.
...
1. It runs container with specifications mentioned under data bag item login-resource-server of communities data bag.

### login-resource-server::ecr_undeploy

Remove Deployed login-resource-server container by referring data bag item login-resource-server of communities data bag.
