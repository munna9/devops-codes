login-auth-server-cookbook
=========================
Deploy and configure  operations on login-auth-server cookbook.
...
### login-auth-server::ecr_deploy

Deploys login-auth-server container by referring data bag item login-auth-server of communities data bag.
...
1. It runs container with specifications mentioned under data bag item login-auth-server of communities data bag.

### login-auth-server::ecr_undeploy

Remove Deployed login-auth-server container by referring data bag item login-auth-server of communities data bag.
