...
Gem::Specification.new do |spec|
  ...
  spec.authors       = ['Rajesh Jonnalagadda']
  spec.email         = ['rajesh.jonnalagadda@phenompeople.com']
  spec.description   = %q{A Docker Driver for Test Kitchen forked from kitchen-docker}
  spec.summary       = spec.description
  spec.homepage      = 'https://bitbucket.org/maheimom/devops_tools/kitchen-docker'
