apply-sig-cookbook
=========================
Deploy and configure  operations on apply-sig cookbook.
...
### apply-sig::ecr_deploy

Deploys apply-sig container by referring data bag item apply-sig of communities data bag.
...
1. It runs container with specifications mentioned under data bag item apply-sig of communities data bag.

### apply-sig::ecr_undeploy

Remove Deployed apply-sig container by referring data bag item apply-sig of communities data bag.
