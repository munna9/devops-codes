...
Deploys apply-sig container by referring data bag item apply-sig of services data bag.
...
1. It runs container with specifications mentioned under data bag item apply-sig of services data bag.

### apply-sig::ecr_undeploy

Remove Deployed apply-sig container by referring data bag item apply-sig of services data bag.
