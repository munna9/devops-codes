email-campaign-cookbook
=========================
Deploy and configure  operations on email-campaign cookbook.
...
### email-campaign::ecr_deploy

Deploys email-campaign container by referring data bag item email-campaign of services data bag.
...
1. It runs container with specifications mentioned under data bag item email-campaign of services data bag.

### email-campaign::ecr_undeploy

Remove Deployed email-campaign container by referring data bag item email-campaign of services data bag.
