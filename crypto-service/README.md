...
Deploys crypto-service container by referring data bag item crypto-service of services data bag.
...
1. It runs container with specifications mentioned under data bag item crypto-service of services data bag.

### crypto-service::ecr_undeploy

Remove Deployed crypto-service container by referring data bag item crypto-service of services data bag.
