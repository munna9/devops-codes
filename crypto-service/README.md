crypto-service-cookbook
=========================
Deploy and configure  operations on crypto-service cookbook.
...
### crypto-service::ecr_deploy

Deploys crypto-service container by referring data bag item crypto-service of communities data bag.
...
1. It runs container with specifications mentioned under data bag item crypto-service of communities data bag.

### crypto-service::ecr_undeploy

Remove Deployed crypto-service container by referring data bag item crypto-service of communities data bag.
