...
=========================
Deploy and configure  operations on knowledge-graph cookbook.
...
### knowledge-graph::ecr_deploy

Deploys knowledge-graph container by referring data bag item knowledge-graph of communities data bag.
...
1. It runs container with specifications mentioned under data bag item knowledge-graph of communities data bag.

### knowledge-graph::ecr_undeploy

Remove Deployed knowledge-graph container by referring data bag item knowledge-graph of communities data bag.
