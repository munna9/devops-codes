...
# update initramfs to persist raid ssh_config
def update_initramfs
  execute 'updating initramfs' do
    Chef::Log.debug('updating initramfs to ensure RAID ssh_config persists reboots')
...
def locate_and_mount(mount_point, mount_point_owner, mount_point_group, mount_point_mode, filesystem, filesystem_options)
  ...
  # update initramfs to ensure RAID ssh_config persists reboots
  update_initramfs
