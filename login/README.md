...
Deploys login container by referring data bag item login of services data bag.
...
1. It runs container with specifications mentioned under data bag item login of services data bag.

### login::ecr_undeploy

Remove Deployed login container by referring data bag item login of services data bag.
