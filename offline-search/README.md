offline-search-cookbook
=========================
Deploy and configure  operations on offline-search cookbook.
...
### offline-search::ecr_deploy

Deploys offline-search container by referring data bag item offline-search of communities data bag.
...
1. It runs container with specifications mentioned under data bag item offline-search of communities data bag.

### offline-search::ecr_undeploy

Remove Deployed offline-search container by referring data bag item offline-search of communities data bag.
