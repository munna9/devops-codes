skill-format-cookbook
=========================
Deploy and configure  operations on skill-format cookbook.
...
### skill-format::ecr_deploy

Deploys skill-format container by referring data bag item skill-format of communities data bag.
...
1. It runs container with specifications mentioned under data bag item skill-format of communities data bag.

### skill-format::ecr_undeploy

Remove Deployed skill-format container by referring data bag item skill-format of communities data bag.
