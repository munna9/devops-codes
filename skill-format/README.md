...
Deploys skill-format container by referring data bag item skill-format of services data bag.
...
1. It runs container with specifications mentioned under data bag item skill-format of services data bag.

### skill-format::ecr_undeploy

Remove Deployed skill-format container by referring data bag item skill-format of services data bag.
