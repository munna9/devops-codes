...
Deploys cp-scoring container by referring data bag item cp-scoring of services data bag.
...
1. It runs container with specifications mentioned under data bag item cp-scoring of services data bag.

### cp-scoring::ecr_undeploy

Remove Deployed cp-scoring container by referring data bag item cp-scoring of services data bag.
