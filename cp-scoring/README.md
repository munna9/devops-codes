cp-scoring-cookbook
=========================
Deploy and configure  operations on cp-scoring cookbook.
...
### cp-scoring::ecr_deploy

Deploys cp-scoring container by referring data bag item cp-scoring of communities data bag.
...
1. It runs container with specifications mentioned under data bag item cp-scoring of communities data bag.

### cp-scoring::ecr_undeploy

Remove Deployed cp-scoring container by referring data bag item cp-scoring of communities data bag.
