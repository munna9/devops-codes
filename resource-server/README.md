resource-server-cookbook
=========================
Deploy and configure  operations on resource-server cookbook.
...
### resource-server::ecr_deploy

Deploys resource-server container by referring data bag item resource-server of communities data bag.
...
1. It runs container with specifications mentioned under data bag item resource-server of communities data bag.

### resource-server::ecr_undeploy

Remove Deployed resource-server container by referring data bag item resource-server of communities data bag.
