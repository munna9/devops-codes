...
Deploys proxy container by referring data bag item proxy of services data bag.
...
1. It runs container with specifications mentioned under data bag item proxy of services data bag.

### proxy::ecr_undeploy

Remove Deployed proxy container by referring data bag item proxy of services data bag.
