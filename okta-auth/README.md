okta-auth-cookbook
=========================
Deploy and configure  operations on okta-auth cookbook.
...
### okta-auth::ecr_deploy

Deploys okta-auth container by referring data bag item okta-auth of services data bag.
...
1. It runs container with specifications mentioned under data bag item **okta-auth** of **services** data bag.

### okta-auth::ecr_undeploy

Remove Deployed okta-auth container by referring data bag item **okta-auth** of **services** data bag.
