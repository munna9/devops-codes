events2db-cookbook
=========================
Deploy and configure  operations on events2db cookbook.
...
### events2db::ecr_deploy

Deploys events2db container by referring data bag item events2db of communities data bag.
...
1. It runs container with specifications mentioned under data bag item events2db of communities data bag.

### events2db::ecr_undeploy

Remove Deployed events2db container by referring data bag item events2db of communities data bag.
