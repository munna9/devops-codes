analytics-proservice-cookbook
=========================
Deploy and configure  operations on analytics-proservice cookbook.
...
### analytics-proservice::ecr_deploy

Deploys analytics-proservice container by referring data bag item analytics-proservice of services data bag.
...
1. It runs container with specifications mentioned under data bag item **analytics-proservice** of **services** data bag.

### analytics-proservice::ecr_undeploy

Remove Deployed analytics-proservice container by referring data bag item **analytics-proservice** of **services** data bag.
