...
default['build-essentials']['maven']['uri'] = "http://mirror.fibergrid.in/apache/maven/maven-3/#{node['build-essentials']['maven']['version']}/binaries/#{node['build-essentials']['maven']['binary_package']}"
