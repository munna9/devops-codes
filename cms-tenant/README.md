cms-tenant-cookbook
=========================
Deploy and configure  operations on cms-tenant cookbook.
...
### cms-tenant::ecr_deploy

Deploys cms-tenant container by referring data bag item cms-tenant of services data bag.
...
1. It runs container with specifications mentioned under data bag item cms-tenant of services data bag.

### cms-tenant::ecr_undeploy

Remove Deployed cms-tenant container by referring data bag item cms-tenant of services data bag.
