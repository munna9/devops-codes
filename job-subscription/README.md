job-subscription-cookbook
=========================
Deploy and configure  operations on job-subscription cookbook.
...
### job-subscription::ecr_deploy

Deploys job-subscription container by referring data bag item job-subscription of services data bag.
...
1. It runs container with specifications mentioned under data bag item job-subscription of services data bag.

### job-subscription::ecr_undeploy

Remove Deployed job-subscription container by referring data bag item job-subscription of services data bag.
